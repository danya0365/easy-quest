/**
 * int_shop.chests.js — what a child finds in the shop.                              (P30, owner: *.chests.js)
 *
 * Five containers, one pays: the counter drawer, where somebody has left money for a boy and will not say so.
 * `found` is the moment it pays; `line` is what is left to say once it has paid.
 */
export default {
  chests: [
    ...
    { id: 'sh_drawer', x: 2.2, z: -2.1, kind: 'drawer', name: 'the counter drawer', line: 'search-drawer', reach: 1.6,
      gold: 5, found: ['%HERO% opens the counter drawer.{wait:350}{n}{gold}5 gold coins{/gold} in a saucer, and a\nnote: "FOR THE BOY. DO NOT TELL\nHIM I SAID SO."',
    ...
    { id: 'sh_sacks', x: -5.4, z: 2.7, kind: 'sack', name: 'the sacks in the corner', line: 'search-sacks', reach: 1.6 },
  ],
  lines: {
    ...
    'search-drawer': ['%HERO% opens the counter drawer.{n}An empty saucer, and a note that\nhas done its job and knows it.'],
