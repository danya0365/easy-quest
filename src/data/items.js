...
const ROWS = [
  ...
  shd('leather_shield', 'Leather Shield', 8, 130, ANY, 'Boiled leather, and a boss you can polish on your sleeve.',
    'Saltmarrow.'),
  shd('iron_shield', 'Iron Shield', 16, 480, ANY, 'Heavy enough that hiding behind it is a real plan.',
    'Port Pelican.'),
  shd('mirror_shield', 'Mirror Shield', 25, 1700, ANY, 'Casts a spell straight back at whoever started it.',
    'Marbleford.', { reflect: ['wobble', 'snoozle', 'sleep'] }),
  shd('dragon_scale_shield', 'Dragon-scale Shield', 34, 4000, ANY, 'Scales off something that stopped minding fire a long time ago.',
  ...
  hlm('leather_cap', 'Leather Cap', 6, 95, ANY, 'Snug, and it squashes your hair into a shape you did not choose.',
    'Saltmarrow.'),
  hlm('iron_helm', 'Iron Helm', 14, 620, ANY, 'Everything anybody says to you sounds like it is happening in a bucket.',
    'Marbleford.'),
