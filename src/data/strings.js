...
export const STR = {
  ...
  'spell.learn': '%NAME% has learnt %SPELL%!{n}It tingles all the way to the\nelbows.',
  ...
  'item.full': 'The bag is full. Something in\nthere would have to go, and\nnothing wants to.',
  ...
  'inn.poor': 'Come back when your purse is\nheavier. The pillows will wait.',
  ...
  'recruit.joined': '%NAME% has joined the party.{n}%NAME% is thrilled about the\nwagon.',
  'recruit.decline': 'The %MONSTER% nods, entirely fine\nabout it, and wanders off to\ntell its mother.',
  'recruit.full': 'The wagon is full of monsters and\nopinions. %NAME% trots off to\nthe paddock at home to wait.',
  'party.swap': '%NAME% climbs down.\n%OTHER% climbs up.',
  'party.wagon.no': 'No wagon down here.\nIt\'s all stairs.',

  // ── searching the world (the discovery voice) ─────────────────────────────────────────────────────────────
  'pot.empty': 'The pot holds nothing but a\nspider, and the spider is not\nfor sale.',
