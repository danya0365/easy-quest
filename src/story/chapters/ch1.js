...
// ═════════════════════════════════════════════════════════════════════════════════════════════════════════════
const b2 = () => [
  spawn('halvard', 'halvard', { ahead: 2.3, side: 0.7 }),
  face('hero', 'halvard'),
  camera.two('halvard'),
...
const b4 = () => [
  music('town'),
  spawn('willow', 'willow', { ahead: 2.4, side: -1.3 }, { build: { age: 'child' } }),
  spawn('sera', 'sera', { ahead: 2.6, side: 1.4 }, { build: { age: 'child' } }),
...
const b6 = () => [
  ...
  music('dungeon'),
  fade('in', { ms: 620 }),
  spawn('willow', 'willow', { ahead: 2.3, side: -1.2 }, { build: { age: 'child' } }),
  spawn('sera', 'sera', { ahead: 2.5, side: 1.3 }, { build: { age: 'child' } }),
  camera.two('willow'),
...
const b8 = () => [
  ...
  spawn('halvard', 'halvard', { ahead: 2.6, side: -0.5 }),
  camera.two('halvard'),
  ...
  spawn('bertie', 'villager:child', { ahead: 2.2, side: 1.3 }),
  camera.two('bertie'),
  ...
  spawn('quietling', 'villager:nun', { ahead: 3.0, side: 0.8 }),
  camera.two('quietling'),
...
const b9 = () => [
  ...
  // ...and then the slow push in on the boy's face, nine seconds, while it happens out of focus behind him
  camera.two('hero', 'halvard', { dist: 2.1, height: 1.05, fov: 34, duration: 4.0 }),
