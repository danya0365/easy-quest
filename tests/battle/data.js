...
export const MONSTERS = Object.fromEntries([
  ...
  mon('mumbleroot', 'Mumbleroot the Grudge', 2, [7, 180, 0, 26, 18, 9, 160, 400, 0], [
    ...
    { boss: true, advice: '"When the candle leans sideways, that old coat is breathing in for a Cold Draught," says the priest. "Heal everybody up before it lets go."', properName: true, neverTargets: ['willow_child', 'willow'], partyLevel: 6,
  ...
  mon('bogwallop', 'Bogwallop the Bulbous', 3, [8, 180, 10, 34, 24, 8, 220, 150, 0], [
    ...
    { boss: true, advice: '"When he goes up on his tiptoes, he is about to belly-flop on the lot of you," says the priest. "Be full of beans when he lands."', properName: true, evade: 0.03, partyLevel: 12,
  ...
  mon('sexton_sootbell', 'Sexton Sootbell', 3, [15, 420, 90, 62, 48, 30, 700, 400, 0], [
    ...
    { boss: true, advice: '"When he reaches for a bell rope that isn\'t there, heal everyone: the toll hurts all of you," says the priest. "And wake up anybody he sends to sleep."', properName: true, partyLevel: 14,
  ...
  mon('tidewarden', 'Tidewarden', 4, [18, 900, 40, 70, 55, 20, 1500, 600, 0], [
    ...
    { boss: true, advice: '"When the water starts to rise, a great wave is coming," says the priest. "Heal everybody the round before it breaks."', partyLevel: 18, spareAtZero: true,
  ...
  mon('hoarfax', 'Hoarfax the Ninefold', 4, [28, 900, 60, 96, 70, 60, 2400, 800, 1 / 8], [
    ...
    { boss: true, advice: '"Hoarfax cannot bear fire," says the priest. "Scorcha is your friend. And when the air turns to glitter, heal up."', properName: true, spareAtZero: true, spareText: 'Hoarfax sits down in the snow and sneezes. All nine tails droop.',
  ...
  mon('iron_governess', 'Iron Governess', 4, [26, 900, 120, 118, 104, 42, 2400, 1200, 0], [
    ...
    { boss: true, advice: '"When she starts counting, her ruler comes down hard on one of you," says the priest. "Keep whoever is lowest topped up."', partyLevel: 24, defeatText: 'The key spins free. %TARGET% folds down into a neat, dignified, harmless heap.',
  ...
  mon('hush', 'Hush', 5, [34, 1100, 120, 120, 90, 70, 3000, 900, 0], [
    ...
    { boss: true, advice: '"Beat one twin and the other one sits down," says the priest. "Pick one, and everybody hit that one."', properName: true, partyLevel: 26, partnerGivesUp: true, spareText: 'Hush lowers her finger and sits down on the floor.' }),
  mon('hark', 'Hark', 5, [34, 1100, 120, 120, 90, 70, 3000, 900, 0], [
    ...
    { boss: true, advice: '"Beat one twin and the other one sits down," says the priest. "Pick one, and everybody hit that one."', properName: true, partyLevel: 26, partnerGivesUp: true, spareText: 'Hark stops listening, and sits down next to his sister.' }),
  mon('mortmain', 'Bishop Mortmain', 5, [38, 2400, 300, 158, 128, 76, 9000, 3000, 0], [
    ...
    { boss: true, advice: '"When he lifts his lantern and the light goes grey, heal everybody," says the priest. "And keep your healers on their feet: he goes for them."', properName: true, partyLevel: 27, spareAtZero: true,
  ...
  mon('malgrim_cocoon', 'Malgrim the Unlit', 5, [45, 1800, 999, 175, 140, 90, 0, 0, 0], [
    ...
    { boss: true, advice: '"When it opens its small hands, everyone is left on one hit point," says the priest. "Somebody always hums. Heal straight after."', properName: true, partyLevel: 28, transformsInto: 'malgrim_unravelling',
  ...
  mon('malgrim_unravelling', 'Malgrim the Unlit', 5, [45, 2700, 999, 175, 140, 90, 0, 0, 0], [
    ...
    { boss: true, advice: '"When it opens its small hands, everyone is left on one hit point," says the priest. "Somebody always hums. Heal straight after."', properName: true, partyLevel: 28,
