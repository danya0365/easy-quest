...
// `boss.level` is the level children really reach the boss door at (tests/battle/journey.mjs, the Fight! child,
// balance pass r3: Bogwallop 15, Hush & Hark 27, Mortmain and Malgrim 28 — each within CANON §8's band or one over).
// `boss.party(L)` (optional) is the party as it really stands at the boss door, measured the same way: who has caught
// up with whom by then (the twins join four levels behind Bram and are two behind by Hoarfax, one by the Governess).
...
export const AREAS = [
  ...
  {
    id: 'whispering_wood', name: 'The Whispering Wood (the children, no Papa)', act: 1, beat: 'B5–B6', leg: 2, tier: 2, areaLevel: 5, tableLvl: 4.75, hpMult: 1.15, levels: [4, 5, 6],
  ...
  {
    id: 'cobwell_manor', name: 'Cobwell Manor', act: 1, beat: 'B6', leg: 3, tier: 2, areaLevel: 6, tableLvl: 5.75, hpMult: 1.45, levels: [5, 6, 7], wagonReachable: false,
    ...
    boss: { enemies: ['mumbleroot'], level: 7, note: 'the belfry',
      party: (L) => build([['hero', 0, W('copper_sword', 'quilted_coat', 'pot_lid', 'straw_hat')], ['willow_child'], ['sera_child'], ['bobble', 0]], L) },
  },
  {
  ...
  // ------------------------------------------------------------------------------------------------ Act II
  {
    id: 'whistling_caves', name: 'The Whistling Caves', act: 2, beat: 'B11', leg: 4, tier: 3, areaLevel: 9, tableLvl: 9.75, hpMult: 1.35, levels: [8, 9, 10], wagonReachable: false,
  ...
  {
    id: 'gogglestone_caves', name: 'Gogglestone Caves (the Sunmane)', act: 2, beat: 'B11b', leg: 4, tier: 2, areaLevel: 11, tableLvl: 9.5, hpMult: 1.25, levels: [10, 11, 12], wagonReachable: false,
  ...
  {
    id: 'pelican_coast', name: 'Pelican Coast (the road to Port Pelican)', act: 2, beat: 'B13–B14', leg: 5, tier: 3, areaLevel: 12, tableLvl: 12.75, hpMult: 1.2, levels: [11, 12, 13],
  ...
  {
    id: 'sogglemarsh', name: 'The Sogglemarsh (round Quaggerton)', act: 2, beat: 'opt', leg: 5, tier: 3, areaLevel: 13, tableLvl: 14.5, hpMult: 1.05, levels: [12, 13, 14],
    ...
    boss: { enemies: ['bogwallop'], level: 15, wagonReachable: false,
      party: (L) => build([
        ['hero', 0, W('iron_lance', 'chain_mail', 'iron_shield', 'leather_cap', 'osrics_wooden_bird')],
        ['barty', -1, W('kitchen_cleaver', 'cooks_apron', 'leather_shield', 'leather_cap')], ['pip', -1], ['bobble', -1], ['digby', -1]], L) },
  },
  {
  ...
  {
    id: 'bellhollow_belfry', name: 'Bellhollow Belfry (Sexton Sootbell)', act: 2, beat: 'opt', leg: 6, tier: 2, areaLevel: 14, tableLvl: 17, hpMult: 1.55, levels: [13, 14, 15], wagonReachable: false,
    party: (L) => build([
    ...
    boss: { enemies: ['sexton_sootbell'], level: 16,
      party: (L) => build([
        ['hero', 0, W('steel_sword', 'chain_mail', 'iron_shield', 'leather_cap', 'osrics_wooden_bird')],
        ['barty', 0, W('iron_lance', 'cooks_apron', 'iron_shield', 'leather_cap')], ['pip', 0], ['bobble', 0]], L) },
  },
  {
  ...
  {
    id: 'ambergarde_road', name: 'The headland road to Ambergarde', act: 2, beat: 'B17–B18', leg: 7, tier: 4, areaLevel: 18, tableLvl: 18.25, hpMult: 1.0, levels: [17, 18, 19],
  ...
  // ------------------------------------------------------------------------------------------------ Act III
  {
    id: 'glasswing_grotto', name: 'The Frostbottom & Glasswing Grotto', act: 3, beat: 'B22', leg: 8, tier: 4, areaLevel: 22, tableLvl: 18.5, hpMult: 1.12, levels: [20, 21, 22], wagonReachable: false,
    ...
    // r3: fewer Mothbonnets and Boulderdashes (Snoozle and Sit Down Heavily made a fifth of these fights free)
    table: [['lady_mothbonnet', 2], ['grimalkitten', 3], ['boulderdash', 1.5], ['gloopold', 1], ['squidgeon', 1.5]],
    group: [1, 2], bag: { strong_herb: 6, honeycake: 1 },
    boss: { enemies: ['hoarfax'], level: 21, party: (L) => ACT3(L, { rowanOff: -2, linnetOff: -2, extra: [['pip', -1], ['bobble', -2]] }) },
  },
  {
  ...
  {
    id: 'quiet_quarry', name: 'The Quiet Quarry (setting it free)', act: 3, beat: 'B22', leg: 8, tier: 4, areaLevel: 23, tableLvl: 24.25, hpMult: 1.1, levels: [22, 23, 24], wagonReachable: false,
    ...
    boss: { enemies: ['iron_governess'], level: 24,
      party: (L) => ACT3(L, { rowanOff: -1, linnetOff: -1, rowan: W('larksteel_sword', 'chain_mail', 'larksteel_shield', 'larksteel_helm'), extra: [['pip', -1], ['bobble', -2]] }) },
  },
  {
