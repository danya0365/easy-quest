...
**Names, ages, flags and acts come from `docs/CANON.md`; if this file disagrees, CANON wins.**
Our hero is a boy of Puddlewick (default name **Bram**), son of the wandering knight **Sir Halvard Bellwether**,
who is secretly the King of Ambergarde. The story runs boy → man → father across three **Acts**. The two bride
choices are both childhood friends: **Willow Pye** of Saltmarrow and **Sera Fairweather** of Marbleford; Sera's
blunt younger sister **Pru** is not a choice. The retainer is **Barty Marrow**, cook and old palace guard. The
villain is **Bishop Mortmain** of the Order of the Quiet Hand. The first monster friend is **Bobble**, a Gloop;
the cat companion is **Pip**, a Sunspot Cub who grows into a great golden Sunmane.
...
```
 ...
 r4   | ~~   TT   TT  [04]  ##   TT   TT   //   //   ~~   ~~   ~~   ~~   ~~ |  THE WHISPERING WOOD
 r5   | ..   TT   ""  [03]  ##   ""   //  [07]  //   ~~   ~~   ~~   ~~   ~~ |  PUDDLEWICK VALE / DOWNS
 r6   | ..   ""  [01]  ##   ##   ##   ##  [06]  ##   ##   >>   ~~  [10]  ~~ |  THE LONG LANE (main road)
 r7   | ..   ""   ##  [05]  //   //   ##  [19]  //   ,,   ..   ~~  [18]  ~~ |  CODDLESTON DOWNS & MOOR
 r8   | ..   ..   ##   //   ,,   ,,   ##   ,,   %%   %%  [09]  ~~  [20]  ~~ |  THE SOGGLEMARSH
 r9   | ~~   ..  [08]  ##   ,,   ,,   ##   ,,   %%   %%   ..   ~~   ~~   ~~ |  PELICAN COAST
 r10  | ~~   ~~   >>   ..   ::   ::   ##   ::   ::   ..   ~~   ~~   ~~  [16]|  THE FRITTERING SANDS
 r11  | ~~   ~~   ~~   ::  [13]  ::   ##  [21]  ::   ~~   ~~   ~~   ~~   .. |
 r12  | ~~   ~~   ~~   ::   ::   ::  [14]  ::   ~~   ~~   ~~   ~~   ~~   ~~ |
      +-------------------------------------------------------------------------+
      [15] HIGHFEATHER — a separate sky layer, directly above r6c7. Reached by the Cloud Stair from [07].
```
...
**Locations.** [01] Puddlewick · [03] Saltmarrow · [04] Cobwell Manor · [05] Gogglestone Caves ·
[06] Coddleston Castle · [07] Bellhollow Abbey · [08] Port Pelican · [09] Quaggerton · [10] Marbleford ·
[11] Coldcomfort · [12] The Glasswing Grotto · [13] Parchmouth · [14] the Quiet Quarry · [15] Highfeather ·
[16] Whistfell Abbey (with the Undercroft and the Quiet Deep beneath it) · [18] Ambergarde · [19] The Grey Ruins
& the Stone Garden (on Coddleston Moor) · [20] The Sighing Grotto · [21] The Whistling Caves.
([02] Hollybank Cottage is an interior inside [01]; [17] Wagonwright's Rest is a one-room waystation on the road
at r7c7.) Map ids for every place: CANON.md §2.

### Travel connections and what gates them

| # | Connection | Gate | Flag / item |
|---|---|---|---|
| T1 | Puddlewick ↔ Saltmarrow (the Beck Bridge, r5-r6 c4) | none — open from minute one | — |
| T2 | Puddlewick Vale ↔ Whispering Wood | none, but Cobwell Manor's door is barred until Willow's dare | `ch1.dare_taken` |
| T3 | Vale ↔ Coddleston Downs (**Coppermill Pass**, r6c5-c7) | a rockfall until Father clears it | `ch1.pass_open` |
| T4 | Downs ↔ Pelican Coast (the Long Lane south) | none | — |
| T5 | Coast ↔ Sogglemarsh (**the Duckboard Causeway**) | needs `item.stiltboots` from Quaggerton's ferryman | `item.stiltboots` |
| T6 | Port Pelican → Parchmouth, and Port Pelican → Marbleford across the Pelican Strait (Captain Sprat's packet boats) | pay 40 gold each way | `ch2.wagon` |
| T7 | **The ship *Merry Lark*** — all `..` shores | Lord Rudolpho's wedding gift | `ch2.ship` |
| T8 | Marbleford ↔ Ambergarde (the headland road, r6-r7 c13) | none, but the Keep gate wants the crest | `ch2.crest` |
...
| T11 | the Quiet Quarry | you do not walk in. Act I ends by dragging you there; Act II starts by walking out through [21]. In Act III the front gate opens | `ch2.start`, `ch3.quarry_freed` |
| T12 | The Gullet (whirlpool ring around [16]) | nothing floats across it; you fly over on **the Sunlark** | `ch3.sunlark` |
| T13 | **Highfeather** | Rowan stands under Bellhollow's empty bell frame with the Larksteel Sword and **the Cloud Stair** unrolls | `ch3.sword_drawn` → `ch3.cloudstair` |
| T14 | The wagon (Papa's wagon, pulled by Parsnip) | follows on `##` and `,,` `""` `..` only; waits outside towns, dungeons and marsh. Act I only while Halvard lives; back from B12 | `ch2.wagon` |
| T15 | The Sunlark | flies anywhere on the overworld, lands on any `..` `,,` `""` tile | `ch3.sunlark` |
...
### [03] `saltmarrow` — town — 44 × 36
**Job:** the first *bigger* place, where the Beck widens into a tidal creek with a little quay. Puddlewick is
home; Saltmarrow is the world beginning. It has the first shop, the first inn bed (**the Contented Herring**,
`contented_herring`, with its parrot), and the first girl who is braver than you. Visited in all three Acts.
**Landmark:** a tide-mill wheel the size of a house, turning, audible from four tiles into the meadow.
**Music:** `town`, but the flute enters only when you cross the bridge — so arriving *sounds* like arriving.
**NPCs:**
- **Willow Pye** — eight, fearless, has already decided you are her friend. "You're the boy from over the beck. You look like you need someone brave." / "There's a ghost house in the wood. I'm going. You can come if you don't cry."
- **Dodd Pye, innkeeper** — Willow's father, kind, permanently apologising for his daughter. "Twelve gold a bed, and I'll not charge the cat." / "If our Willow has told you about the manor, she's told you a *version* of it."
...
- **Goodwife Sump** — sells vegetables, gossips at extraordinary speed. "Turnips, turnips, and — no, that's a turnip too." / "Sir Halvard walked through at dawn. Grim as a Monday, that man."
**Searchable:** 11 barrels, 6 pots, the mill hopper (hides 30 gold under the flour), the inn's wardrobe
(a **Homing Feather**), a bookshelf that reads out the first hint about the Manor's music boxes.
**Pulled onward by:** Willow, physically. She walks to the north gate, stops, waits, and calls your name once
every twenty seconds until you follow.

### [04] `cobwell_manor` — dungeon — 48 × 44 across three floors
...
**Pulled onward by:** Willow goes on ahead every time you dawdle, and you can hear her whistling one room away.

### [05] `gogglestone_caves` — dungeon — 34 × 30, two floors
**Job:** Act I (optional): the small, safe, wet cave that teaches "dark places are fine, actually". Act II
(B11b): the den of **the Sunmane** — Pip, grown huge and wild, who knows Bram by the ribbon.
...
**Music:** `dungeon`, thinned to a low drone and dripping water; the melody only returns in the Sunmane's den.
**NPCs:**
...
**Searchable:** 8 pots left by miners, 3 ore veins (sparkle points, 100% — copper, then a **Gloop Crown**
on the third), and one crack in the wall you can only see if you walk right of the waterfall (**hidden path
→ a pot of 200 G in Act I; the Sunmane's den in Act II**).
**Pulled onward by:** in Act II, a deep rumbling purr that gets louder as you approach the correct fork. The
audio *is* the map.

### [06] `coddleston` — town (castle) — 56 × 50, courtyard + two interior floors
**Job:** awe. Prince Bertie's home: the first building bigger than your whole village, where Father kneels to
someone (Act I, B8). In Act III King Bertie lends you his fleet.
...
**NPCs:**
- **King Alverd the Mild** — a tired, decent man who would rather be gardening. "Sir Halvard. And a small Sir Halvard. Splendid." / "I am told a king should be terrible. I am mostly damp."
...
**Music:** `church`, played very quietly; a single sustained chord when you save.
**NPCs:**
...
- **Old Mossop, who is always here** — nobody knows if he is staff. "I'm waiting." / "For? Oh. I've stopped asking myself that. Ruins the waiting."
...
for the next dungeon, a real mechanic), and the belfry stair — optional in Act II, where **Sexton Sootbell**
haunts the empty frame and guards the **Charm Bell** (`bellhollow_belfry`). In Act III, Rowan stands under the
empty frame with the Larksteel Sword and **the Cloud Stair** to Highfeather unrolls from it.
**Pulled onward by:** the Abbot's second line always names your current objective in gentle, non-quest-y words.

### [08] `port_pelican` — town — 52 × 40
**Job:** the smell of the wider world (Act II hub). Gulls, rope, tar, strangers with accents. Captain Sprat's
packet boats to Parchmouth and across the Pelican Strait to Marbleford; the optional **monster arena**; a Bank.
...
**NPCs:**
- **Captain Marla Sprat** — small, terrifying, twenty-nine ships and no first mate left. "You've sea in you. Or you've eaten something." / "Forty gold to Parchmouth or Marbleford. And if you're sick, you're sick over the *side*, not the cat."
...
- **Herbalist Sorrel** — sells cures, believes in absolutely all of them. "Marsh-thistle. Cures everything except being wrong." / "You look peaky. Everyone looks peaky. It's the light. It's *always* the light."
...
**Job:** wealth, and how funny wealth is. This is where the bride plot happens in Act II.
**Landmark:** Fairweather Hall — white, absurd, forty windows, a hedge cut into the shape of the family.
**Music:** `town`, but strings-and-harpsichord, a minuet, slightly too pleased with itself.
**NPCs:**
- **Sera Fairweather** — beautiful, sheltered, kinder than her house. "I've been outside exactly once. It had ghosts in it." / "Everyone who comes here wants something. You want... directions? Oh. How *restful*."
- **Pru Fairweather** — younger, blunt, the funniest person in the game. "You've got hay on you. Don't move it, it's the most interesting thing here." / "My sister is very good. I'm very *accurate*. People prefer good."
- **Lord Rudolpho Fairweather** — the father; loud, loving, ridiculous, would die for his daughters. "WHO. Speak up. WHO ARE YOU." / "A pearl, boy. Not gold — anyone has gold. Bring me the Tide Pearl, from the grotto under my cliffs. *Yourself*."
...
**Searchable:** 24 containers (25%), but Fairweather Hall's are gold-heavy (average 80g). The hedge maze hides
a **Golden Comb**. Under Sera's window: a ladder somebody left, and a line about who left it.
**Pulled onward by:** Rudolpho states the pearl quest at volume; the HUD line becomes "Bring the Tide Pearl to Sera's father."

### [11] `coldcomfort` — town — 38 × 32
**Job:** endurance made cosy (Act III). Deep snow outside, absurd warmth inside every door, and a steaming hot
spring in the square where the whole village sits up to its chins and gossips.
...
- **Crag the trapper** — laconic, has three words a day and spends them well. "Grotto's shut. Ice." / "You'll want the Emberbell. Nasty little thing. Works."
...
**Pulled onward by:** Crag walks to the north gate and points. He does not say anything. He points.
...
**Job:** somewhere genuinely foreign, and the first soft place after the worst thing (Act II, B11).
...
hides the far end of a smuggler's tunnel into the Whistling Caves — the way you came out of the Quarry.
**Pulled onward by:** in Act II this is the first soft place after the quarry. Ashani's lines seed the dread.

### [14] `quiet_quarry` — dungeon — 50 × 30, mostly linear
**Job:** the ten years. The Act break. Not a place you explore; a place that happens to you. Everybody here is a
*worker*, put to work by the Order; nobody in this game is called a slave. In Act III you come back through the
front gate and set them all free (boss **the Iron Governess** on the overseer's gantry).
**Landmark:** a black step-pyramid of cut stone that grows a course taller each cutscene.
**Music:** `family` reduced to a work-rhythm — one drum, one voice humming the Puddlewick theme wrong.
**NPCs:**
- **Fellow worker Osric** — became your friend over a decade, in about nine lines total. "New lad. Don't look up. Looking up's how they see you." / "Ten years. You were a boy when you got here. Don't tell me the year."
...
- **Prince Bertie**, eighteen — see STORY-BIBLE B10; his recited titles get shorter every chore. (And lying in the dust by the pyramid's mouth: the clapper of the stolen Bellhollow bell. Examine: "A bell's tongue. Somebody took a bell's voice out on purpose.")
...
**Pulled onward by:** the escape — Digby the Barrowmole digs the last yard into the Whistling Caves [21], with Bertie. Never timed.

### [15] `highfeather` — dungeon/castle — 40 × 40, a sky island
...
at dawn, at 4% opacity, forever, from the very first minute of the game. You climb to it up **the Cloud Stair**
from Bellhollow Abbey's empty bell frame (Act III, B23). Inside sleeps **the Sunlark**.
**Music:** a new theme, `highfeather`: choir pad, harp, no percussion, and it never resolves its last chord.
**NPCs:**
...
- **Clover the Featherhorse** — the Keeper's enormous friendly bird-horse with opinions (not a mount — the Sunlark is how you fly). "*(Clover regards you, then lowers one wing like a staircase.)*" / "*(Clover has eaten your hat. Clover is not sorry.)*"
...
**Pulled onward by:** Ammiel shows you the list — sword, shield, helm, cloak — ticks three off with visible surprise, hands
you the **Larkweave Cloak**, and points at the golden shape asleep on the highest tower.

### [16] `whistfell_abbey` — dungeon — 60 × 52, four floors
**Job:** the Order of the Quiet Hand's grey abbey on an island inside the Gullet (reached only on the Sunlark).
The last climb, and the reunion: your mother sleeps in a lit glass lantern in **the Whistfell Undercroft**
(`whistfell_undercroft`), and below that is the final dungeon, **the Quiet Deep** (`quiet_deep`). Mid-boss:
**Hush & Hark**, the Quiet Twins.
**Landmark:** an iron bell-tower with the stolen Bellhollow bell inside it, ringing wrong.
**Music:** `quiet_hand` — the battle melody played slow and sacred on organ; the villain's theme is your battle theme, ruined.
...
- **Queen Elowen** — your mother, asleep in the one lit lantern of the Undercroft; the game's throat-tightening moment (STORY-BIBLE T3). After she wakes: "I knew the shape of you before I knew the face." / "Your father sat you on the wall and said 'that one's ours.' Both of you. He meant both of you."
- **Bishop Mortmain** — the villain, courteous throughout, which is worse. "You have come a very long way to be told no." / "I don't want the world to end. I want it to be *quiet*."
**Searchable:** 27 containers (30% — endgame generosity). Mortmain's study has a diary that explains him in
three entries, and a small portrait of a boy called Tobin, and makes an eleven-year-old sad.
**Pulled onward by:** the stolen bell gets louder the deeper you go. Volume is the compass.
...
**NPCs:** **Wagonwright Doss** ("Wheel's twelve gold. Bed's cheaper. Bed's better value and I hate that."),
...
In Act II (B12) Doss finally finishes a wheel — for Papa's old wagon — and Fenna has nothing left to say (`ch2.wagon`).


### [18] `ambergarde` — town — 44 × 38, plus `ambergarde_keep` (interior, three floors)
**Job:** belonging. The little kingdom Bram's father really ruled; the crest opens its gate (Act II, B18) and
everyone in it has been waiting seventeen years without quite admitting it.
**Landmark:** amber-tiled roofs on a green headland, and a keep with one round tower like a lighthouse.
**Music:** `castle`; the Keep's throne room drops to harp alone the first time you enter it.
**NPCs:**
- **Chancellor Grebe-Wick** — very old, very correct, has kept the throne dusted. "Your father sat there. Badly. He fidgeted." / "We kept the crown polished. It seemed rude not to."
- **Nurse Hallam** — in Act III, raised the twins with Barty. "They bite. Both of them. Lovingly." / "Nine years of bedtimes and your daughter still thinks it's a negotiation."
- **The Sword in the Stone** — the Larksteel Sword (examine: "It is not stuck. It is *waiting*.").
- **A Quietling in the kitchens** (epilogue only) — has quit the Order. "I prefer soup to silence. Don't tell anyone."
**Searchable:** 22 containers (25%); the Keep's nursery (Act III) hides the twins' drawings of their parents.
**Pulled onward by:** Barty, who has been steering you here all Act; in Act III, the twins run ahead.

### [19] `grey_ruins` & `stone_garden` — dungeon + field — 36 × 30 and 30 × 30, on Coddleston Moor
**Job:** the worst place and the best place are next door. The Grey Ruins are where Halvard falls (Act I, B9);
the walled Stone Garden beside them is where Mortmain keeps his statues, where Linnet chips her father free
(Act III, B20), and where everyone wakes (B26).
**Landmark:** one broken grey arch on the moor, visible from Coddleston's walls.
**Music:** `tension` in the Ruins; `silence`, then `family.whole`, in the Garden.
**NPCs:** dozing **Quietlings** (Act III — sneak past them); statues who each have one frozen line on examine
("…and then I said to him, *Gerald* —"); after B26, all of them, finishing their sentences.
**Searchable:** 8 containers in the Ruins (Act III only); **Halvard's Greatsword** by the plinth in the Garden.
**Pulled onward by:** in B20, the light on the two statues holding hands; the camera never lets you lose them.

### [20] `sighing_grotto` — dungeon — 40 × 36, two tide levels
**Job:** the proof. Lord Rudolpho's condition lives here (the **Tide Pearl**), and Willow walks it beside you.
**Landmark:** a sea-cave mouth under Marbleford's cliffs that sighs, loudly, every time a wave goes in.
**Music:** `dungeon` with a slow wash of sea under the drone; the sigh is on the beat.
**NPCs:** **a crab lighthouse-keeper called Mister Nip** ("Tide's in. Tide's out. Tide's *thinking*." /
"I keep the light. Nobody asked me to. That's the best sort of job.") and the boss, **the Tidewarden**.
**Searchable:** 14 containers (30%); the sluice puzzles never trap you — the tide resets when you leave a room.
**Pulled onward by:** Willow, who knows boats, calls which way the water is going.

### [21] `whistling_caves` — dungeon — 38 × 30, two floors
**Job:** getting out (Act II, B11). Wind puzzles; first battles as a grown man.
**Landmark:** three holes in a sandstone ridge that whistle a chord when the desert wind blows.
**Music:** `dungeon`, with a wind voice that plays the Hearth Cell's first two notes when a gust passes.
**NPCs:** **Bobble**, at the far mouth, on a rock, with a packed lunch, ten years later ("Frankly, Bobble was
early."); an old digger's ghost who only says "Left. No — *your* left."
**Searchable:** 10 containers (25%). **Pulled onward by:** the wind, which always blows toward the exit.

---

## 3. Puddlewick — the home village, in loving detail

`puddlewick`, kind `town`, **40 × 34 tiles**, theme `grass`, music `village` (MUSIC-BIBLE T2).
...
and a window that looks at the chestnut tree. Behind it, a barn (Papa's wagon waits here in Act II) and a
fenced **paddock** where monster friends who don't fit in the wagon live happily and can be visited.
...
**Music:** the Puddlewick theme (`village`) is the game's *home motif*: flute over harp, in G, 6/8. It is quoted
in the title screen, hummed wrong at the Quiet Quarry, played in full brass at the end of Act III, and its first
eight notes are the Glasswing Grotto chime puzzle. Its C section is **Queen Elowen's lullaby** — the tune the
Cobwell Manor music boxes play, though nobody tells you that until Act III. A child who plays this game will hum it in the car.
...
- **Barty Marrow** — your family's cook: small, wide, bald, terrible singer, will follow you anywhere later. "I've made a stew. It's mostly stew." / "You go on and play. I'll be here. I'm always here, me."
- **Dot and Bel, twins of seven** — play a chasing game with rules they invent live. "You're It. You've been It since Tuesday." / "New rule: the well is safe. New rule: it isn't."
Plus **six wandering sheep**, **a cat on the bakery wall**, **a duck who has decided the well is his**, and a
**potted Cactuddle** on the green who says something new every Act (MONSTER-BIBLE §8).

### Visit 1 — Act I, the hero is a boy (while `chapter == 1`)
...
`rate: 0.02` and the monsters are Gloops and Bloops, and the Bloops apologise when they pop.
...
### Visit 2 — Act II, the hero is a man, ten years on (from `ch2.start`; B12)
**What changes, exactly:**
1. **Time of day forced to overcast dawn**; `light.sun` down 40%, fog up, saturation −25% on the palette.
2. Music: the Puddlewick theme, but **only the bass line**, no flute. The melody is missing and a child will
...
7. NPCs: **3 only** — Old Hob (older, still at the well, "Well's still deep. Some things keep."),
   a squatter family (the Pooles: mother Kit, boy Rill) who are frightened of you until you speak twice,
   and **Barty Marrow**, inside Hollybank Cottage, who has waited here for ten years, and whose first line is his
   second line from Visit 1: "I said I'd be here." Then, once, plainly: "He died, little master." He joins the
   party permanently in this scene (STORY-BIBLE B12).
8. **Hollybank Cottage** is intact but stripped: no chairs, dust motes in the light shaft — but the **hearth is
   lit**, because Barty has kept the fire in every night for ten years. The loft bed is still made. Searching
   it gives **Papa's Letter** and **Mum's Feather Hairpin**; both go in Important Items and never leave.
   The barn holds Papa's old wagon with a broken wheel (Wagonwright Doss mends it: `ch2.wagon`).
9. Encounters in the surrounding meadow now `rate: 0.06`, table swapped to Twiglets and Grumbleglops.

### Visit 3 — Act III, the hero is a father (from `ch3.sword_drawn`; Nan Puddifoot only after `ch3.elowen`)
**What changes, exactly:**
1. Time of day: **noon**, brightest lighting in the game; a rebuild flag makes seven houses whole, with
   **new thatch on four of them** — visibly newer straw, a different colour. The player paid for it in Act III
   (300 G into Old Hob's rebuilding pot at the well) and the game shows exactly where the money went.
2. Music: full Puddlewick theme, flute **and** a second voice — a child's recorder, slightly flat, doubling it.
3. Nan Puddifoot is back (she was rescued from Whistfell Abbey) and the oven is lit. Her line: "Warm one,
...
4. **Your two children** play the twins' chasing game on the green, with the twins' exact invented rules,
   now grown-up rules taught to them by Dot and Bel, who are adults with jobs and are visibly bored by it.
...
### DUNGEON A — Cobwell Manor (Act I, party Lv 4–7)
Three floors, 48 × 44. You enter with **Willow**, age eight, who is braver than you and says so, **Sera**, seven,
who invited herself, and **Bobble**. No adults.
...
|---|---|---|
| **A1 Porch & Front Hall** | Barnaby the Butler-shade blocks you politely until you say your name. Two sconces, a coat-stand with four coats and one is warm. | Teaches: talk to ghosts, they are people. Chest: **Candle** (mandatory). Barnaby also hands you a **Retreat Bell** — "for guests who find they must leave" — the first one in the game. |
...
| **A5 The Long Stair** | Master Fen, the boy hiding under the stairs. Wind here blows the candle out. | The gut-punch. In the dark, before you relight, **Willow tears her ribbon in half and ties one half on Bram's wrist** (`ch1.ribbon`; STORY-BIBLE B6). She goes quiet for the next two rooms. |
| **A6 Nursery (1F)** | A cot, a rocking horse that rocks, **Music Box 1** on the shelf, and a hatbox that mews. | Take the box. The horse stops. Open the hatbox: **Pip**, a ginger Sunspot Cub with two tiny sabre teeth, joins (`party.pip`). Sera gives him the little brass bell off her bonnet. |
...
| **A11 The Belfry (3F)** | **BOSS: Mumbleroot the Grudge.** A tangle of root and grief in a wedding coat, 180 HP, two attacks (Bind: skip a turn; Cold Draught: blows the candle out and darkens the battle backdrop for one round). It never targets Willow. | Beaten, it unravels into a plain black coat lying on the floor. No death rattle. |
| **A12 The Ballroom, after** | **Grandmother Nettle**, lady of the house, sweeps in to complain about the dust (STORY laugh #4), then: The three boxes wind. The waltz plays *right* for the first time. Ottilie and the groom-shade dance one circuit. Every ghost claps. Barnaby weeps and apologises for weeping. | **Treasure:** the **Silver Waltz-Charm** (accessory, +5 luck; description: "Somebody was finally allowed to go home.") plus 400g in the coat pockets. |
...
### DUNGEON B — The Glasswing Grotto (Act III, party Lv 22–25)
...
| **B9 The Reliquary** | **Treasure: the Larksteel Shield** (one of the four Larksteel pieces), plus 3 chests: **Ice-Silk Robe**, 2000g, and a **Seed of Life**. | The shield gets a full ceremony: fanfare, held aloft, camera orbit, the `highfeather` theme's first four bars. |
...
| Drawers, wardrobes, cupboards | **1 in 3** | gold, one key item per Act, a clothing joke |
...
| Coddleston Castle (all classes) | **1 in 6** | it's a joke and the empty lines carry it |
| the Quiet Quarry | **1 in 4 of 4 containers** | poverty as level design |
...
1. **Behind the waterfall.** Taught in Gogglestone Caves. Reused in Glasswing (B7) and Whistfell (F3).
...
3. **The loose board.** Quaggerton teaches it (drop through the walkway). Reused in Port Pelican's quay and
   Hollybank's loft.
...
6. **The visible unreachable chest.** Placed in view early (the Manor's belfry, seen from A2) to teach that
   the world continues. Always eventually reachable, always in the same Act it was shown.
...
Examples: *"Follow your father to the pass."* · *"Find three music boxes."* · *"Ask Willow about the manor."*
· *"Bring the Tide Pearl to Sera's father."* It updates on the *same frame* an NPC finishes the line that
...
("Coddleston — a morning's walk"). A signpost never lists a place you cannot yet reach without also saying
...
far layer with fog: Puddlewick's **chestnut tree**; Saltmarrow's **tide-mill wheel**; Coddleston's **four green
spires**; Bellhollow's **empty bell frame**; Port Pelican's **crane**; Quaggerton's **tree-house**;
Marbleford's **white hall**; Ambergarde's **amber roofs on the green headland**; the Grey Ruins' **broken arch**; Coldcomfort's **orange chimney-smoke**; Parchmouth's **single palm**;
the Quiet Quarry's **black step-pyramid**; Whistfell's **iron bell tower**; and above them all, at 4% opacity from
the first minute of the game, **Highfeather**. The rule: *if you can see it, you can walk to it.*

**5. People who tell you, in character.** Three tiers:
- **The Town Crier NPC.** Every town has one (Puddlewick: Old Hob; Saltmarrow: Goodwife Sump; Coddleston:
...
- **Escort NPCs.** In Act I, Willow and Father physically walk to the next place and wait, calling your
  name every 20 seconds. A child follows a person; a child ignores an arrow.
- **The companion point.** Bobble or Pip (and later any front-of-wagon monster) will, if you stand still for six
...
- **No dungeon can trap you.** You own a reusable **Retreat Bell** from Cobwell Manor's front hall onward, and a
  spare stands on a plinth within 20 tiles of every dungeon entrance and outside every boss door; the Homing
  Feather works everywhere outdoors.
- **No one-way door closes behind you without a visible way back**, and the way back is on the minimap
  before the door shuts.
- **No missable item.** If an Act is about to end and something is unclaimed, an NPC hands it to you.
- **No unwinnable state.** Defeat = wake at the nearest church, half your gold, everything else intact, and
  the Abbot says something kind. Gold kept in a Bank (Saltmarrow, Port Pelican, Marbleford, Ambergarde) is
  never lost, which the Abbot explains once, in one sentence, the first time you have over 200g.
...
*End of the World Bible. Regions: 9. Enterable locations: 21. Named NPCs: 70+. Every one of them is a person
